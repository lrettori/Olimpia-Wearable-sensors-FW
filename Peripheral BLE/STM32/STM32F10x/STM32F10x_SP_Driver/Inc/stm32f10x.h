 ...
 * @}
 */
#include "nrf52.h"                                                              // ORIGINAL IS core_cm3.h
...
/******  Cortex-M3 Processor Exceptions Numbers ***************************************************/
  ST_NonMaskableInt_IRQn         = -14,    /*!< 2 Non Maskable Interrupt                             */
  ST_MemoryManagement_IRQn       = -12,    /*!< 4 Cortex-M3 Memory Management Interrupt              */
  ST_BusFault_IRQn               = -11,    /*!< 5 Cortex-M3 Bus Fault Interrupt                      */
  ST_UsageFault_IRQn             = -10,    /*!< 6 Cortex-M3 Usage Fault Interrupt                    */
  ST_SVCall_IRQn                 = -5,     /*!< 11 Cortex-M3 SV Call Interrupt                       */
  ST_DebugMonitor_IRQn           = -4,     /*!< 12 Cortex-M3 Debug Monitor Interrupt                 */
  ST_PendSV_IRQn                 = -2,     /*!< 14 Cortex-M3 Pend SV Interrupt                       */
  ST_SysTick_IRQn                = -1,     /*!< 15 Cortex-M3 System Tick Interrupt                   */
...
#define ST_SET_BIT(REG, BIT)     ((REG) |= (BIT))
