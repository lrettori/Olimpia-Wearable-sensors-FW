...
#define INT_GEN_THS_X_XL_REG_ADDR       0x07  
...
#define CTRL_REG2_G_ADDR                0x11                                    /*Angular rate sensor register 2*/
#define CTRL_REG3_G_ADDR                0x12                                    /*Angular rate sensor register 3*/
...
#define INT_GEN_THS_XL_G_REG_ADDR       0x32                                    /*angular rate interrup generator thershold*/
#define INT_GEN_THS_YH_G_REG_ADDR       0x33                                    /*angular rate interrup generator threshold*/
#define INT_GEN_THS_YL_G_REG_ADDR       0x34                                    /*angular rate interrup generator thershold*/
#define INT_GEN_THS_ZH_G_REG_ADDR       0x35                                    /*angular rate interrup generator threshold*/
#define INT_GEN_THS_ZL_G_REG_ADDR       0x36                                    /*angular rate interrup generator thershold*/
...
#define CTRL_REG1_M_ADD                 0x20                                    /*magnetometer control register 1*/
#define CTRL_REG2_M_ADD                 0x21                                    /*magnetometer control register 2*/
#define CTRL_REG3_M_ADD                 0x22                                    /*magnetometer control register 3*/
#define CTRL_REG4_M_ADD                 0x23                                    /*magnetometer control register 4*/
#define CTRL_REG5_M_ADD                 0x24                                    /*magnetometer control register 5*/
...
#define INT_THS_H_M_REG_ADD             0x33                                    /*magnetometer interrupt thershold value*/

#define LSM9DS1_Acc_Sens_2              0.061                                   /*!< accelerometer sensitivity with 2 g full scale [mg/LSB] */
#define LSM9DS1_Acc_Sens_4              0.122                                   /*!< accelerometer sensitivity with 4 g full scale [mg/LSB] */
#define LSM9DS1_Acc_Sens_8              0.244                                   /*!< accelerometer sensitivity with 8 g full scale [mg/LSB] */ 

#define LSM9DS1_Gyr_Sens_245            8.75                                    /*!< gyroscope sensitivity with 245 dps full scale   [mdps/LSB] */
#define LSM9DS1_Gyr_Sens_500            17.50                                   /*!< gyroscope sensitivity with 500 dps full scale   [mdps/LSB] */
#define LSM9DS1_Gyr_Sens_2000           70                                      /*!< gyroscope sensitivity with 2000 dps full scale  [mdps/LSB] */ 

#define LSM9DS1_Mag_Sens_4              0.14                                    /*!< magnetometer sensitivity with 4 gauss full scale   [mgauss/LSB] */
#define LSM9DS1_Mag_Sens_8              0.29                                    /*!< magnetometer sensitivity with 8 gauss full scale   [mgauss/LSB] */
#define LSM9DS1_Mag_Sens_12             0.43                                    /*!< magnetometer sensitivity with 12 gauss full scale  [mgauss/LSB] */ 
#define LSM9DS1_Mag_Sens_16             0.58                                    /*!< magnetometer sensitivity with 16 gauss full scale  [mgauss/LSB] */ 
...
//#define LSM9DS1_AG_BDU_Single                     ((u8)0x40)
#define LSM9DS1_M_BDU_Continuos                   ((u8)0x00)
//#define LSM9DS1_M_BDU_Single                      ((u8)0x40)
